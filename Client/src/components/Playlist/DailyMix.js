      ...
      <div className="home_middle">
        <div className="mood_inner">
          <div className="mood_inner1">
            <img
              src="https://i.scdn.co/image/ab67616d0000b273d9a129c4a656a55afff2ca02"
              alt="logo"
          ...
          <div className="mood_inner_info">
            ...
            <div className="mood_header">Daily Mix Plays</div>
            <div>Ap Dhillon and more...</div>
          </div>
        </div>
        <div className="mood_playlist_wrap">
          ...
          <div className="mood_list">
            <table>
              ...
              <tbody>
                {songs.slice(274, 324).map((song, i) => {
                  let id = i + 1;
                  return (
