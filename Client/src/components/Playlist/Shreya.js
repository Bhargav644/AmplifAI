...
function Shreya() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://127.0.0.1:5000/Shreya");
  ...
  const handlePlayClick = () => {
    const selected = songs.slice(0, 50);
      ...
      <div className="home_middle">
        <div className="mood_inner">
          <div className="mood_inner1">
            <img
              src="https://i.scdn.co/image/ab67616d0000b2732c1912dc94b3b86e01de0a1f"
              alt="logo"
          ...
          <div className="mood_inner_info">
            ...
            <div className="mood_header">Shreya Ghoshal Plays</div>
            <div>2023 Top Shreya Ghoshal Songs</div>
          </div>
        </div>
